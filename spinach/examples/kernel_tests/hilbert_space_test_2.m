% Parallelization test: multi-threaded evaluation of final point in Hilbert
...
for n=[128 64 32 16 8 4 2 1]
    ...
    tic
        hs_evolution(spin_system,H,[],rho,timestep,nsteps,'final');
    toc
    matlabpool('close');
end
