...
%
%    correlation_test_3(0.1,0.2,0.3,2,5,2,5)
%
% ilya.kuprov@oerc.ox.ac.uk

function correlation_test_3(sigma_x,sigma_y,sigma_z,k,m,p,q)
...
for n=1:npoints
    ...
    R_gen=sigma_z*[ 0  1  0; -1  0  0;  0  0  0]*angles(1,n)+...
          sigma_y*[ 0  0  1;  0  0  0; -1  0  0]*angles(2,n)+...
          sigma_x*[ 0  0  0;  0  0  1;  0 -1  0]*angles(3,n);
    R=expm(R_gen);
...
spin_system.rlx.tau_c=1./(3*[sigma_x sigma_y sigma_z].^2);
