...
if isempty(pulse_number), error('vg_pulse: incorrect pulse name.'); end
...
% certainty which a noble soul has about itself, something which is 
% not to be sought, is not to be found, and perhaps, also, is not to 
