...
function jlh_f6250_16spins_1parfor()
...
% Interactions
sys.isotopes={'E','14N','1H','1H','1H','1H','1H','1H','1H','1H','1H','1H','1H','1H','1H','1H'};
inter.zeeman.matrix=cell(16,1);
inter.zeeman.matrix{1,1}=[ 2.0056023 -0.0013775 -0.0004019; -0.0008185 2.0038816 0.0002087; -0.0002747 0.0001729 2.0062982];
inter.coupling.matrix=cell(16,16);
...
save('jlh_f6250_16spins_1parfor.dat','data', '-ASCII');